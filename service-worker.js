...
const CACHE_NAME = "pathfinder-paladins-folders-v231";
...
const ASSETS = [
  ...
  "./assets/gate-bg-desktop.webp","./assets/gate-bg-mobile.webp","./assets/valid-sources.js","./assets/class-visuals.js","./assets/class-visuals.css"
];
