const CACHE_NAME = "pathfinder-paladins-folders-v195";
const ASSETS = [
  "./","./index.html","./hub.html","./sanctum.html","./icon-192.png","./icon-512.png","./favicon-32.png","./favicon-48.png",
  "./assets/gate-bg.jpg","./assets/valid-sources.js","./assets/casting-time.js",
  "./assets/spell-crossref.js","./assets/spell-master-index.json","./assets/spell-crossrefs.json","./assets/conditions.js","./assets/domains.js","./assets/oaths.js","./assets/animal-companion-species-core.json","./assets/character-catalog-companion-compatibility.json",
