...
test('all 44 class profiles and 1161 archetype profiles are present and marked valued', () => {
  ...
  assert.equal(archetypes.length, 1161);
  ...
  assert.equal(catalogue.counts.valuedArchetypes, 1161);
});
