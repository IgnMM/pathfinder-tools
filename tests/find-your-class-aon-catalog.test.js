...
test('all 44 class profiles and 1203 archetype profiles are present and marked valued', () => {
  ...
  assert.equal(archetypes.length, 1203);
  ...
  assert.equal(catalogue.counts.valuedArchetypes, 1203);
});
