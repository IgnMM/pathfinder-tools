...
test('all 44 class profiles and 1243 archetype profiles are present and marked valued', () => {
  ...
  assert.equal(archetypes.length, 1243);
  ...
  assert.equal(catalogue.counts.valuedArchetypes, 1243);
});
