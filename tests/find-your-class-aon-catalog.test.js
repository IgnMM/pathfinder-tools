...
test('all 44 class profiles and 1123 archetype profiles are present and marked valued', () => {
  ...
  assert.equal(archetypes.length, 1123);
  ...
  assert.equal(catalogue.counts.valuedArchetypes, 1123);
});
