...
test('find-your-class-v2/index.html resolves all class profiles and archetype batches into one profile set at bootstrap', () => {
  ...
  for (const id of ['antipaladin','arcanist','barbarian','bard','bloodrager','brawler','cavalier','cleric','druid','fighter','gunslinger','hunter','inquisitor','investigator','kineticist','magus','medium','mesmerist','monk','monk-unchained','ninja','occultist','oracle','paladin','psychic','ranger']) assert.match(pageHtml, new RegExp(`archetype-profiles-${id}\\.json`));
